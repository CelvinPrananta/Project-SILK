...
<body oncontextmenu="return false">
    ...
    <style>
        ...
        .slide-card-atass .currency{color: {{ auth()->user()->warna_sistem_tulisan }} !important}
        .slide-card-bawahs .currency{color: {{ auth()->user()->warna_sistem_tulisan }} !important}
        .slide-card-atass h2{color: {{ auth()->user()->warna_sistem_tulisan }} !important}
        .slide-card-bawahs h2{color: {{ auth()->user()->warna_sistem_tulisan }} !important}
        .arrow-kanan{color: {{ auth()->user()->warna_sistem_tulisan }} !important}
        .arrow-kanan2{color: {{ auth()->user()->warna_sistem_tulisan }} !important}
        .arrow-kiri{color: {{ auth()->user()->warna_sistem_tulisan }} !important}
        .arrow-kiri2{color: {{ auth()->user()->warna_sistem_tulisan }} !important}
        ...
        .slide-card-atass{background: {{ auth()->user()->warna_mode }} !important}
        .slide-card-bawahs{background: {{ auth()->user()->warna_mode }} !important}
        ::-webkit-scrollbar-thumb{background: {{ auth()->user()->warna_mode }}}
        .action-button2{background: {{ auth()->user()->warna_mode }}}
        .action-button{background: {{ auth()->user()->warna_mode }}}
        ...
        .slide-card-atass:hover{background: {{ auth()->user()->warna_dropdown_menu }} !important}
        .slide-card-bawahs:hover{background: {{ auth()->user()->warna_dropdown_menu }} !important}
        ::-webkit-scrollbar{background: {{ auth()->user()->warna_dropdown_menu }}}
